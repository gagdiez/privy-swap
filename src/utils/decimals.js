 ...
 */
export const unitsToDecimal = (amount, decimals) => {
 ...
 */
export const decimalToUnits = (displayAmount, decimals) => {
  if (!displayAmount || displayAmount === '' || displayAmount === '0')
    return '0'
 ...
 */
export const formatNumber = (displayAmount, maxDecimals = 6) => {
